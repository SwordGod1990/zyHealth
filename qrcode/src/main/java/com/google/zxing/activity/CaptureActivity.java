...
import com.google.zxing.qrUriUtil;
...
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
    ...
    private void handleAlbumPic(Intent data) {
        //获取选中图片的路径
        photo_path = qrUriUtil.getRealPathFromUri(CaptureActivity.this, data.getData());
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (result != null) {
                    ...
                    bundle.putString(qrConstant.INTENT_EXTRA_KEY_QR_SCAN, result.getText());
...
//		});
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            ...
            Intent resultIntent = new Intent();
            Bundle bundle = new Bundle();
            bundle.putString(qrConstant.INTENT_EXTRA_KEY_QR_SCAN, resultString);
