...
public class LogException {
    ...
    private static volatile LogException instance = null;
    ...
    public ApiException throwableUtils(Throwable throwable) {
        ...
        if (throwable instanceof EOFException || throwable instanceof ConnectException) {
            ...
            return apiException;
        } else if (throwable instanceof Transformer.ServerException) {
            Transformer.ServerException resultException = (Transformer.ServerException) throwable;
            ...
            return apiException;
        } else if (throwable instanceof Transformer.TokenException) {
            Transformer.TokenException tokenException = (Transformer.TokenException) throwable;
