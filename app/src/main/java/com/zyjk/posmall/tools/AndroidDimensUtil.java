...
public class AndroidDimensUtil {
    ...
    private static final int baseWidth = 320;
...
//        System.out.println("生成Width : " + dimenWidth + " , 基准Width : " + baseWidth + " , width比例 : " + scaleWidth);
        ...
        File lay_xFile = new File("./app/src/main/res", "lay_x.xml");
        File lay_yFile = new File("./app/src/main/res", "lay_y.xml");
