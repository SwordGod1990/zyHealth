...
public class HomePresentAdapter extends CommonAdapter<String> {

    private Context context;
    private List<String> list;

    public HomePresentAdapter(Context context, int item_goodsenquiry_gift, ArrayList<String> list) {
    ...
    protected void convert(final ViewHolder holder, String s, final int position) {
        holder.setText(R.id.item_goodsEnquiry_present_name_tv, s);
