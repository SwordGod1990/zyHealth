...
public class ScavengersAdapter extends CommonAdapter<FoodModel> {
    private Context context;
    private List<FoodModel> datas;
    private ScavengersActionCallback callback;

    public ScavengersAdapter(Context context, int layoutId, List<FoodModel> datas, ScavengersActionCallback callback) {
    ...
    protected void convert(ViewHolder holder, FoodModel foodModel, int position) {
        holder.setText(R.id.item_scavengers_goodsNum_tv, foodModel.getNum() + "");
        holder.setText(R.id.item_scavengers_money_tv, foodModel.getPrice() + "");
        holder.setText(R.id.item_scavengers_factoryContent_tv, foodModel.getDescription());
        holder.setText(R.id.item_scavengers_drugName_tv, foodModel.getName());
        TextView drugName = holder.getView(R.id.item_scavengers_drugName_tv);
        //-----------------------------字体过长尾部以...显示
         ...
         * ------------------------ 删除条目 ------------------------
         */
        holder.getView(R.id.item_scavengers_delete_ll).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                DiffUtil.DiffResult diffResult = DiffUtil.calculateDiff( new );
         ...
         * ------------------------ 购物车（加）------------------------
         */
        holder.getView(R.id.item_scavengers_AddGood_iv).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
         ...
         * ------------------------ 购物车（减）------------------------
         */
        holder.getView(R.id.item_scavengers_reduceGood_iv).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
