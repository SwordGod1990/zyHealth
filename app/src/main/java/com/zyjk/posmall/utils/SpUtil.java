...
public class SpUtil {
    ...
    public static void setInt(Context context, String key, int value) {
        getSharePerference(context).edit().putInt(key, value).commit();
    }
    ...
    public static int getInt(Context context, String key, int defValue) {
        return getSharePerference(context).getInt(key, defValue);
    }
    ...
    public static void setBoolean(Context context, String name, String key, boolean value) {
        getSharePerference(context, name).edit().putBoolean(key, value).commit();
    }
